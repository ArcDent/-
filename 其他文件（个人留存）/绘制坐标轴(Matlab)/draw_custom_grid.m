function draw_custom_grid(varargin)
    % 绘制自定义坐标系（使用示例：draw_custom_grid('XPosUnit','V','XNegUnit','mV')）
        ...
        addParameter(p, 'XPosScale', 0.01);%设置x正轴刻度值的缩放比例
        addParameter(p, 'XNegScale', 1);%设置x负轴刻度值的缩放比例
        addParameter(p, 'YPosScale', 1);%设置y正轴刻度值的缩放比例
        addParameter(p, 'YNegScale', 0.05);%设置y负轴刻度值的缩放比例
        ...
        addParameter(p, 'XPosMax', 120);%设置x正轴显示范围
        addParameter(p, 'XNegMax', -15);%设置x负轴显示范围
        addParameter(p, 'YPosMax', 15);%设置y正轴显示范围
        addParameter(p, 'YNegMax', -160);%设置y负轴显示范围
